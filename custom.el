(custom-set-variables
 ...
 '(term-bind-key-alist
   '(("C-a" . term-bol)
     ...
     ("M-n" . next-line)
     ("M-y" . yank-pop)
     ("M-." . term-send-raw-meta)) t nil "Customized with use-package multi-term"))
(custom-set-faces
