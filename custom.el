(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (hydra harvest ivy dumb-jump xkcd yard-mode yasnippet yaml-mode yagist wgrep-ag web-mode switch-window smex solarized-theme rubocop rspec-mode rbenv projectile paredit multi-term magithub magit markdown-mode kaesar js2-mode ido-completing-read+ gitignore-mode gitconfig-mode flx-ido flycheck-pos-tip flycheck feature-mode exec-path-from-shell enh-ruby-mode dictionary browse-kill-ring auto-package-update aggressive-indent ag use-package-ensure-system-package delight)))
